<template>
	<section class="root">
		<button id="add-feature" @click="remove_feature">
			<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
        <rect width="30" height="6" rx="3" transform="matrix(0.711889 -0.702292 0.711889 0.702292 0 21.0688)" fill="#EEF5DB"/>
        <rect width="30" height="6" rx="3" transform="matrix(-0.711889 -0.702292 0.711889 -0.702292 21.6708 25.6476)" fill="#EEF5DB"/>
      </svg>
		</button>
...
export default defineComponent({
  ...
  methods: {
    remove_feature() {
      this.$emit("featureRemoved", this.id)
    }
  }
});
</script>
	...
	// grid sections {
		...
		button {
			&::before {
				...
				bottom: 0;
				left: 0;
				background-image: linear-gradient(180deg, #ff4343 0%, #c66ac3 100%);
				z-index: -1;
			...
			border-radius: 0 10px 10px 0;
			background: linear-gradient(180deg, #F36C76 0%, #F37C6C 100%);
			border-style: none;
			font-size: 3rem;
			color: white;
			z-index: 1;
